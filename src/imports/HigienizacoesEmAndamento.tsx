import svgPaths from "./svg-4dskegm9qz";
...
function TableHeader5() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-[70px]" data-name="Table header">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[#525051] text-[12px] text-nowrap whitespace-pre">Status</p>
    </div>
  );
}
...
function TableCell2() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[8px] h-[32px] items-center justify-center p-[8px] relative shrink-0 w-[208px]" data-name="Table cell">
      <div aria-hidden="true" className="absolute border-[#ededf2] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#8c8c8f] text-[12px] w-[192px]">Lote-663115520</p>
    </div>
  );
}
...
function TextAndSupportingText4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[70px]" data-name="Text and supporting text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#8c8c8f] text-[12px] text-nowrap whitespace-pre">Consultando</p>
    </div>
  );
}
...
function PauseCircle() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="pause-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="pause-circle">
          <path d={svgPaths.p38707400} id="Icon" stroke="var(--stroke-0, #F79009)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function TextAndSupportingText9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[70px]" data-name="Text and supporting text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#8c8c8f] text-[12px] text-nowrap whitespace-pre">Aguardando</p>
    </div>
  );
}
...
function TextAndSupportingText14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[70px]" data-name="Text and supporting text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#8c8c8f] text-[12px] text-nowrap whitespace-pre">Parado</p>
    </div>
  );
}
...
function TextAndSupportingText19() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[70px]" data-name="Text and supporting text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#8c8c8f] text-[12px] text-nowrap whitespace-pre">Pausado</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="play-circle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="play-circle">
          <g id="Icon">
            <path d={svgPaths.pace200} stroke="var(--stroke-0, #12B76A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            <path d="M10 8L16 12L10 16V8Z" stroke="var(--stroke-0, #12B76A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </g>
        </g>
      </svg>
    </div>
...
function TextAndSupportingText24() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[70px]" data-name="Text and supporting text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#8c8c8f] text-[12px] text-nowrap whitespace-pre">Parcial</p>
    </div>
  );
}
...
function Content() {
  return (
    <div className="box-border content-stretch flex gap-[8px] items-center justify-center pb-[16px] pt-0 px-[4px] relative shrink-0" data-name="Content">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#65a603] text-[14px] text-nowrap whitespace-pre">Em andamento</p>
    </div>
  );
}
...
function Content1() {
  return (
    <div className="box-border content-stretch flex gap-[8px] items-center justify-center pb-[16px] pt-0 px-[4px] relative shrink-0" data-name="Content">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#b4b4b8] text-[14px] text-nowrap whitespace-pre">Finalizados</p>
    </div>
  );
}
...
function Pagination() {
  return (
    <div className="absolute box-border content-stretch flex items-center justify-between left-[16px] px-[16px] py-[12px] top-[calc(60%+86px)] w-[904px]" data-name="Pagination">
...
function HigienizacoesEmAndamento() {
  return (
    <div className="absolute bg-white h-[720px] left-[244px] overflow-clip top-0 w-[936px]" data-name="Higienizações - em andamento">
      <InputField />
      <Frame />
      <HorizontalTabs />
      <ButtonBase />
...
export default function HigienizacoesEmAndamento1() {
  return (
    <div className="relative size-full" data-name="Higienizações - em andamento">
      <HigienizacoesEmAndamento />
      <SubNavDitto />
      <HeaderNavigation />
    </div>
  );
